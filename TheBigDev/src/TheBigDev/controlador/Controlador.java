...
public class Controlador {
    ...
    public void mostrarClientes() {
        System.out.println(" - - - - - - - - ");
        ArrayList<Cliente> clientes = datos.getListaClientes().getArrayList();
    ...
    public void eliminarPedido(Integer numero) {
        try {
            ...
            if( now.isAfter(pedidoDate.plusDays(2)) ) {
                System.out.println(ANSI_RED_BACKGROUND+"ERROR: no se puede eliminar el pedido porque se realizao hace más de 2 días: "+ANSI_RESET);
                return;
            }
